...
router.register(r'bearinglocations', BearingLocationViewSet, basename="bearinglocation"),
router.register(r'alertlimits', AlertLimitsViewSet, basename="alertLimits"),
models_list = apps.get_models()
excluded_models = ['logentry', 'contenttype', 'session', 'permission', 'group', 'bearinglocation', 'machine', 'user', 'alertlimit']

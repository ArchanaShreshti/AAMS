...
excluded_models = ['logentry', 'contenttype', 'session', 'permission', 'group', 'BearingLocation']
...
urlpatterns = [
    ...
    # path('bearinglocations', BearingLocationViewSet.as_view({'get': 'list'}), name="customBearingLocation"),
